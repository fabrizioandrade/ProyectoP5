...
const PropertiesGrid = () => {
  ...
  const addToFavorite = async (propertyId) => {
    try {
      ...
      console.log(favs);
      dispatch(setFavorites(favs.data.validFavorites))
        ...
        <path d="M12 12C13.1046 12 14 11.1046 14 10C14 8.89543 13.1046 8 12 8C10.8954 8 10 8.89543 10 10C10 11.1046 10.8954 12 12 12Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex ml-5 p-2">
                    {favorites?.includes(property.id)?(<p>ya esta</p>):( <button onClick={()=>addToFavorite(property.id)} className="border border-gray-800 ">
